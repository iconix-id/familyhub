  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          'CHAT',
          style: TextStyle(color: MainAppTheme.nearlyWhite, fontWeight: FontWeight.bold),
        ),
        centerTitle: true,
      ),
      body: ChatScreen(
...
class ChatScreenState extends State<ChatScreen> {
        ...
        children: <Widget>[
          document['type'] == 0
              ...
              ? Container(
                  ...
                  width: 200.0,
                  decoration: BoxDecoration(color: Colors.yellow, borderRadius: BorderRadius.circular(8.0)),
                          ...
                          child: CachedNetworkImage(
                            placeholder: (context, url) => Container(
                              child: CircularProgressIndicator(
                                valueColor: AlwaysStoppedAnimation<Color>(MainAppTheme.nearlyBlue),
                              ),
                              width: 200.0,
                              height: 200.0,
              ...
              children: <Widget>[
                ...
                document['type'] == 0
                    ? Container(
                        ...
                        padding: EdgeInsets.fromLTRB(15.0, 10.0, 15.0, 10.0),
                        width: 200.0,
                        decoration: BoxDecoration(color: MainAppTheme.nearlyDarkBlue, borderRadius: BorderRadius.circular(8.0)),
            ...
            isLastMessageLeft(index)
                ? Container(
                    child: Text(
                      ...
                      style: TextStyle(color: MainAppTheme.grey, fontSize: 12.0, fontStyle: FontStyle.italic),
                    ),
  ...
  Widget buildSticker() {
    return Container(
      ...
      decoration: BoxDecoration(border: Border(top: BorderSide(color: MainAppTheme.dark_grey, width: 0.5)), color: Colors.white),
      ...
      child: Row(
        children: <Widget>[
          ...
          Flexible(
            child: Container(
              child: TextField(
                style: TextStyle(color: MainAppTheme.nearlyDarkBlue, fontSize: 15.0),
  ...
  Widget buildListMessage() {
    return Flexible(
      child: groupChatId == ''
          ? Center(child: CircularProgressIndicator(valueColor: AlwaysStoppedAnimation<Color>(MainAppTheme.nearlyBlue)))
          : StreamBuilder(
              ...
              builder: (context, snapshot) {
                if (!snapshot.hasData) {
                  return Center(
                      child: CircularProgressIndicator(valueColor: AlwaysStoppedAnimation<Color>(MainAppTheme.nearlyBlue)));
                } else {
